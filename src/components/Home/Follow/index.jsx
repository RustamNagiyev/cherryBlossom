...
const accessToken =
  "IGQWRORHJNdHJsVkNBeWZASYVpONVJCVlhpZAkVTU2p3WWg2cmlUQXJrS0xfelhOSUNHWEpVMlA5b1BJeElsby1jWTFNVEpqS1M5RmJBdHlkaFRCeldaVk81bEF1cW95eklSRTVpT1AtakFPbkVZAbEVDYUtOR2Y2cHcZD";
  ...
  return (
    <div className="follow">
      <div>
        ...
        <Link to="https://www.instagram.com/floweers.baku/">
          <p className="follow-address">@CHERRYBLOSSOM.LA</p>
          {data ? (
